            ...
            <!-- <div class="w-full  rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700"> -->
                ...
                <h3 class="text-3xl font-extrabold">Login</h3>
                    ...
                    <form class="space-y-4 md:space-y-6" action="/wikie/app/controller/auth.php" method="post">
                        ...
                        <p class="text-sm mt-6 text-center">you want to skip login now? <a href="/wikie/app/view/visiteur.php" class="text-gray-600 font-semibold hover:underline ml-1 whitespace-nowrap">Next time</a></p>
                    </form>
                </div>
            </div>
        </div>
